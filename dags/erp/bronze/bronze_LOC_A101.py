...
with DAG(
    dag_id="erp_bronze_loc_a101",
    schedule=None,
) as dag:

    @task
    def extract_loc_a101():
    ...
    @task
    def load_loc_a101(extract_result):
        ...
        object_name = f"bronze/erp/loc_a101/{partition_date}/loc_a101.parquet"
    ...
    staging_path = extract_loc_a101()

    load_loc_a101(staging_path)
